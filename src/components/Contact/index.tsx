      ...
      <section className="overflow-hidden py-20 bg-gray-50">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex flex-col xl:flex-row gap-7.5">
            <div className="xl:max-w-[370px] w-full bg-white rounded-xl shadow-md border-2 border-gray-200">
            ...
            <div className="xl:max-w-[770px] w-full bg-white rounded-xl shadow-md border-2 border-gray-200 p-4 sm:p-7.5 xl:p-10">
              <form>
                ...
                <div className="mb-7.5">
                  ...
                  <textarea
                    ...
                    className="rounded-md border border-gray-300 bg-gray-50 placeholder:text-gray-400 w-full p-5 outline-none duration-200 focus:border-transparent focus:shadow-md focus:ring-2 focus:ring-black/20"
                  ></textarea>
                </div>
