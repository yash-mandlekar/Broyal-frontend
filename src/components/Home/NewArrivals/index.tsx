      ...
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="mb-12 md:mb-16 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          ...
          {!loading && !error && products.length > 0 && (
            <Link
              href="/shop"
              className="inline-flex items-center gap-2 font-semibold text-base py-3 px-7 rounded-lg transition-all duration-300 hover:scale-105 bg-black text-white hover:bg-black-light shadow-bw-medium"
            >
              View All
              <ArrowRight size={18} />
            </Link>
        ...
        {loading ? (
          ...
          <div className="col-span-full py-12 text-center rounded-2xl bg-gray-soft border-2 border-gray-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
            {products && products.length > 0 ? (
              ...
              <div className="col-span-full py-16 text-center rounded-2xl bg-white-soft border-2 border-gray-3">
