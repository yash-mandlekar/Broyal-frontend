  ...
  return (
    <div className="flex items-center border-t border-gray-200 py-5 px-7.5">
      <div className="min-w-[400px]">
        <div className="flex items-center justify-between gap-5">
          <div className="w-full flex items-center gap-5.5">
            ...
            <div>
              <h3 className="text-black ease-out duration-200 hover:text-gray-700">
      ...
      <div className="min-w-[180px]">
        <p className="text-black">${item.product.discountPrice}</p>
      </div>
      ...
      <div className="min-w-[275px]">
        <div className="w-max flex items-center rounded-md border border-gray-200">
          <button
            ...
            className="flex items-center justify-center w-11.5 h-11.5 ease-out duration-200 hover:text-black"
          >
            <svg
          ...
          <span className="flex items-center justify-center w-16 h-11.5 border-x border-gray-300">
            {quantity}
          </span>
      ...
      <div className="min-w-[200px]">
        <p className="text-black">${item.product.discountPrice * quantity}</p>
      </div>
      ...
      <div className="min-w-[50px] flex justify-end">
        <button
          ...
          className={`flex items-center justify-center rounded-lg max-w-[38px] w-full h-9.5 bg-gray-100 border border-gray-200 text-gray-700 ease-out duration-200 hover:bg-red-50 hover:border-red-200 hover:text-red-600 disabled:opacity-50 disabled:cursor-not-allowed ${
