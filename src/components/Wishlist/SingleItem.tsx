    ...
    <div className="flex items-center border-t border-gray-200 py-5 px-10">
      <div className="min-w-[83px]">
        <button
          ...
          className="flex items-center justify-center rounded-lg max-w-[38px] w-full h-9.5 bg-gray-100 border border-gray-200 text-gray-700 ease-out duration-200 hover:bg-red-50 hover:border-red-200 hover:text-red-600"
        >
          <svg
      ...
      <div className="min-w-[150px] flex justify-end">
        <button
          ...
          className="inline-flex text-white bg-black border border-black py-2.5 px-6 rounded-md ease-out duration-200 hover:bg-gray-800 hover:border-gray-800"
        >
          Add to Cart
        </button>
      </div>
